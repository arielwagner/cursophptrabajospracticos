...
class Headers {
	...
	public function offLogon() {
		...
		<form id="frmOffLogon" name="frmOffLogon" class="'.FILE_INDEX.'" method="post">
		<table><tr>
		<td><img src="'.PATH_VIEWS.'/'.PATH_IMAGES.'/lampOff.png" width="16" height="16"></td>
		<td>Usuario: </td>
		...
		<td></td>
		<td><a href="'.FILE_INDEX.'?logon=register&amp;">
		Registrarse</a></td>
		<td></td>
		<td><a href="'.FILE_INDEX.'?logon=forgot&amp;">
	...
	public function onLogon() {
		...
		<table><tr>
		<td><img src="'.PATH_VIEWS.'/'.PATH_IMAGES.'/lampOn.png" width="16" height="16"></td>
		<td>Usuario: </td>
		<td>'.$_SESSION['userSE'].'</td>
		<td> - </td>
		<td><a href="'.FILE_INDEX.'?logon=Off&amp;">Cerrar Sesi&oacute;n</a></td>
		</tr></table>'; 
		return $sc;		
	}
	...
	public function errorLogon() {
		...
		<p></p>
		<label><a href="'.FILE_INDEX.'?logon=errorLogon&amp;">
		Reintentar</a></label>';
		return $sc;				
	}
	...
	public function forgotUser() {
		...
		<form id="frmForgot" name="frmForgot" class="'.FILE_INDEX.'" method="post">
		<table><tr><td>&nbsp;</td>
		...
		<td><a href="'.FILE_INDEX.'">Cancelar</a></td>
		</tr></tr></table>
		</form><p></p>';
		return $sc;	
	}
	...
	public function resultUser($dts) {
		if($dts->countRows() > 0) {
			...
			<p><a href="'.FILE_INDEX.'">Iniciar Sesi&oacute;n</a></p>
			<p></p>';
		} else {
			$sc='<p></p>
			<label><p>DATOS DEL USUARIO</p></label>
	...
	public function newRegisterUser() {
		...
		<form id="frmRegister" name="frmRegister" class="'.FILE_INDEX.'" method="post">
