...
<?php
	...
	echo "</br>";
	echo "Este es un ejemplo muy sencillo que nos muestra cómo funciona PHP";
	echo "</br>";
 	echo "Parte del código está de PHP está embebido en HTML.";
	echo "</br>";
?>
<p>Es un </p><?php echo " trozo "; ?><p>de</p><? echo " PHP "; ?><p>embebido en HTML</p>
</body>
</html>