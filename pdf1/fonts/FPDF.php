<?php
/*******************************************************************************
* CLASE NO EDITABLE - SOLO LECTURA
* FPDF                                                                         *
*                                                                              *
* Version: 1.6                                                                 *
* Date:    2008-08-03                                                          *
...
// Agregado por Job Systems Solution ~ Con fines Pedagógicos y no comerciales
function aboutMe($x=0, $y=0) {
	// Firma de la empresa y el desarrollador...
    $this->Ln();
    $this->SetFont('Arial','', 8);
    $ms = 'Job Systems Solutions © 2013 - Desarrollado por Wagner, Ariel Alejandro ~ Email: arielwagner@hotmail.com';
    $this->Text($x, $y, $ms);
    $this->Line($x, $y + 1, 200, $y + 1);
    $this->Ln();
}
