...
// Manejar Advertencias de Errores de Indices de Arrays.
...
<?php if($_SESSION['statusSE']=='') { ?>
	<p>Descargar: Guia de PHP y MySQL</p>
<?php } else { ?>
	<p>Descargar: <a href="sesiones.php?down=down1&amp;" class="links">Guia de PHP y MySQL</a></p>
<?php } ?>
<p></p>
</div>
</section></article>
<!-- Pie de la pagina -->
<footer><div id="footerFix"><p>Desarrollado por Job Systems Solutions Copyright &copy; 2013</p></div></footer>
</body>
</html>
